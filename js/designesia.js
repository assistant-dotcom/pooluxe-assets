 /* --------------------------------------------------
  * © Copyright 2026 - Pooluxe by Designesia
  * --------------------------------------------------*/
(function($) {
    'use strict';
    ...
    const headerAutoshow = "on"; // on > enable header auto visible on scroll, off > disable header auto visible on scroll
    ...
    let lastScrollPosition;
     ...
     function initResize() {
       ...
       // Screen ≤ 992px
       enquire.register(`screen and (min-width: ${btnHideWidth}px)`, {
           match() {
               $('header').find('.btn-main').show();
           },
           unmatch() {
               $('header').find('.btn-main').hide();
           }
       });
